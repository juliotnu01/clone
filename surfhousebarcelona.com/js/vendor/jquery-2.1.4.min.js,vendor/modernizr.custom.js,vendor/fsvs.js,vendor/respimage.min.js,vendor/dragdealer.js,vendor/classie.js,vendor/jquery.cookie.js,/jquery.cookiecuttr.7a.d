...
;( function($){
	...
	$.fn.fsvs = function( options ) {
		...
		var mouseWheelHandler = function( ev ) {
			...
			// NO Tocar porque firefox lo necesita
		...
		var app = {
			...
			setSpeed : function( _speed ) {
				...
				body.css({
					...
					'-moz-transition'	: 'transform ' + speed + 's',
					'-o-transition'		: 'transform ' + speed + 's',
    ...
    $.cookieCuttr = function (options) {
        ...
        if (($cookieAccepted) || ($cookieDeclined)) {
            ...
            if ((cookieNoMessage) && (!cookiePolicyPage)) {
                ...
                if (appOrPre) {
                    $('body').append('<div class="cc-cookies ' + cookieOverlay + '">' + cookieAnalyticsMessage + cookieAccept + cookieDecline + cookieWhatAreLinkText + '</a></div>');
                } else {
                    $('body').prepend('<div class="cc-cookies ' + cookieOverlay + '">' + cookieAnalyticsMessage + cookieAccept + cookieDecline + cookieWhatAreLinkText + '</a></div>');
                }
            }
        ...
        //Guardar al navegar por el sitio
        $(document).click(function () {
            ...
            $(".cc-cookies").fadeOut("slow",function () {
            });
        });
